package com.hank.speechengine.microphone;

import javax.sound.sampled.AudioFileFormat;
import com.hank.speechengine.util.*;
...
public class MicrophoneAnalyzer extends Microphone {
	 ...
	 * @param data data you want to apply the window to
	 ...
	 * Hanning Windows are used to increase the accuracy of the FFT.
	 * One should always apply a window to a dataset before applying an FFT
	 * @param signal_in data you want to apply the window to
	 * @param pos starting index you want to apply a window from
	 ...
	 * @param c data you want to remove the complex transforms from
	 ...
	 * @param input you want to get max magnitude from.
