...
public class Recognizer {
   ...
   /**
     ...
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForWave(File waveFile, int maxResults) throws IOException{
//        com.hank.speechengine.recognizer.FlacEncoder flacEncoder = new com.hank.speechengine.recognizer.FlacEncoder();
//        File flacFile = new File(waveFile + ".flac");
//
//        flacEncoder.convertWaveToFlac(waveFile, flacFile);

//        com.hank.speechengine.recognizer.GoogleResponse googleResponse = getRecognizedDataForWav(waveFile, maxResults, 16000);
        
        //Delete converted FLAC data
//        flacFile.delete();
        String [] response = rawRequestWav(waveFile, maxResults, 16000);
        com.hank.speechengine.recognizer.GoogleResponse googleResponse = new com.hank.speechengine.recognizer.GoogleResponse();
        parseResponse(response, googleResponse);
        return googleResponse;
    }
    private String[] rawRequestWav(File inputFile, int maxResults, int sampleRate) throws IOException{
        URL url;
        ...
        urlConn.setRequestProperty("Content-Type", "audio/l16; rate=" + sampleRate);
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForWave(String waveFile, int maxResults) throws IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForFlac(File flacFile, int maxResults) throws IOException {
     ...
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForFlac(File flacFile, int maxResults, int sampleRate) throws IOException{
     ...
     * @throws IOException if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForFlac(String flacFile, int maxResults, int sampleRate) throws IOException{
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForFlac(String flacFile, int maxResults) throws IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForWave(File waveFile) throws IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForWave(String waveFile) throws IOException {
        return getRecognizedDataForWave(waveFile, 1);
    }
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForFlac(File flacFile) throws IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public com.hank.speechengine.recognizer.GoogleResponse getRecognizedDataForFlac(String flacFile) throws IOException {
        return getRecognizedDataForFlac(flacFile, 1);
    }
     ...
     */
    private void parseResponse(String[] rawResponse, com.hank.speechengine.recognizer.GoogleResponse googleResponse) {
