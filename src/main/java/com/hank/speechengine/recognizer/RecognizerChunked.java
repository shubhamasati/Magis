...
import com.hank.speechengine.util.StringUtil;
...
public class RecognizerChunked {
	 ...
	 */
	private final List<com.hank.speechengine.recognizer.GSpeechResponseListener> responseListeners = new ArrayList<com.hank.speechengine.recognizer.GSpeechResponseListener>();
				...
				try {
					...
					while ((line = br.readLine( )) != null) {
						if(line.length()>19 && resCode > 100 && resCode < HttpURLConnection.HTTP_UNAUTHORIZED){
							com.hank.speechengine.recognizer.GoogleResponse gr = new com.hank.speechengine.recognizer.GoogleResponse();
	 ...
	 */
	private void parseResponse(String rawResponse, com.hank.speechengine.recognizer.GoogleResponse gr){
	 ...
	 */
	public synchronized void addResponseListener(com.hank.speechengine.recognizer.GSpeechResponseListener rl){
	 ...
	 */
	public synchronized void removeResponseListener(com.hank.speechengine.recognizer.GSpeechResponseListener rl){
	 ...
	 */
	private synchronized void fireResponseEvent(com.hank.speechengine.recognizer.GoogleResponse gr){
		for(com.hank.speechengine.recognizer.GSpeechResponseListener gl: responseListeners){
			gl.onResponse(gr);
		}
	}
