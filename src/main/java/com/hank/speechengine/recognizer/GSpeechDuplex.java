...
public class GSpeechDuplex {
     ...
     * Stores listeners
     */
    private final List<GSpeechResponseListener> responseListeners = new ArrayList<GSpeechResponseListener>();
    /**
     ...
     *
     * @param urlStr URL you want to connect to.
     */
    ...
    private Thread upChannel(String urlStr, TargetDataLine tl, AudioFormat af) throws IOException, LineUnavailableException {
        ...
        Thread upChannelThread = new Thread("Upstream Thread") {
            public void run() {
                ...
                System.out.println("Finished the Upstream thread");
            }
        };
    ...
    private void openHttpsPostConnection(String murl, TargetDataLine mtl, int sampleRate) {
        ...
        try {
            ...
            int bytesWritten = AudioSystem.write(ais, FLACFileWriter.FLAC, out);
